...
import com.miguelpimenta.buildlog.vehicle.dto.VehicleSummaryResponse.DynoSnapshot;
...
/**
 * Builds the derived {@code /summary} view. Reads modifications and dyno
 * results for a vehicle and aggregates them - the one piece of genuine
 * business logic beyond CRUD, and the part worth unit testing thoroughly.
 */
@Service
