...
public class Modification {
  ...
  // Persist the enum by name, not ordinal, so the enum can be reordered without corrupting rows.
  ...
  // precision/scale map to SQL DECIMAL(12,2): up to 12 digits, 2 after the point - exact money, no
  // rounding drift.
  ...
  // Owning side of the many-to-one: this table holds the vehicle_id FK; LAZY defers loading the
  // parent.
